...
public class Trie {
    ...
    private class Node {
        ...
        public Node[] getChildren() {
            return children.values().toArray(new Node[0]); // without this new Node[0] arg, it'll return
            // array of objects, so pass this empty node array
        }
    ...
    public boolean contains(String word) {
        ...
        return current.isEndOfWord; // if you have canada already, and now you're searching for can,
        // it should return true only if n is the last word, in this case false cause after n,
        // we've got ada!
    }
    ...
    private void traverse(Node root) {
        // pre-order: visit the root first, if you want postorder traversal, move this print statement
        // after the for loop below! You cannot inorder though!
